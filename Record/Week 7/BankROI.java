...
class Customer {
    ...
    void displayCustomer() {   // displayCustomer mthod to display the customer details
        System.out.println("Customer ID   : " + customerId);
        System.out.println("Customer Name : " + name);
    }
}
// Account class to display the customer bank details
class Acc {
    int accountNumber;
    double balance;
...
// SBI derived class SBI inherited RBI
...
// ICICI derived class  ICICI inherited RBI
...
// PNB derived class PNB inherited RBI
